...
=======
	\centering    \fbox{\includegraphics[width=\textwidth, height=10cm]{main.png}}
...
\begin{figure}[H]
	\centering   \fbox{\includegraphics[height=16cm]{cartes.png}}
\end{figure}
...
\begin{figure}[H]
	\centering   \fbox{\includegraphics[width=\textwidth, height=6cm]{eval_utils.PNG}}
\end{figure}
...
\section{Transgression de règles ergonomiques}
   ...
   \subsection{Règle 2:4 : Réduire la charge de travail de l'utilisateur}
    ...
    On pourrait tout simplement automatiser certains processus afin de faciliter le travail de l'utilisateur et lui permettre d'effectuer certaines opérations directement depuis notre site Web.
     \begin{figure}[H]
    	\centering
        \fbox{\includegraphics[scale=0.60]{2_4_corr.png}}
...
=======
        	\fbox{\includegraphics[width=\textwidth,height=4cm]{10_2_expl.png}}
>>>>>>> 87a95cb13b37f248b3994ad80745b3a0dcd7aa61
...
=======
        	\fbox{\includegraphics[width=\textwidth,height=4.5cm]{10_2_corr.PNG}}
>>>>>>> 87a95cb13b37f248b3994ad80745b3a0dcd7aa61
   ...
   \subsection{Règle 14:4 : Utiliser les vidéos, les animation et l'audio de manière sensée}
    	    ...
    	    \subsubsection*{Explication de la transgression}
    	       ...
    	       \begin{figure}[H]
    	       	\centering
<<<<<<< HEAD
    	       	\fbox{\includegraphics[scale=0.40]{14_4_expl.PNG}}
=======
    	       	\fbox{\includegraphics[width=\textwidth, height=10cm]{14_4_expl.PNG}}
>>>>>>> 87a95cb13b37f248b3994ad80745b3a0dcd7aa61
...
=======
	    	      	\fbox{\includegraphics[width=\textwidth, height=6.5cm]{14_4_corr.PNG}}
>>>>>>> 87a95cb13b37f248b3994ad80745b3a0dcd7aa61
...
=======
     	\fbox{\includegraphics[width=\textwidth, height=8cm]{16_3_expl.PNG}}
>>>>>>> 87a95cb13b37f248b3994ad80745b3a0dcd7aa61
...
=======
     	\fbox{\includegraphics[width=\textwidth, height=9cm]{16_3_corr.PNG}}
>>>>>>> 87a95cb13b37f248b3994ad80745b3a0dcd7aa61
...
<<<<<<< HEAD
    ...
    \begin{figure}[H]
     ...
     \begin{figure}[H]
     	\centering
  	\fbox{\includegraphics[scale=0.60]{reglement_club.png}}
     	\caption{La page contenant le règlement du club}
     \end{figure}
     \begin{figure}[H]
     	\centering
  	\fbox{\includegraphics[scale=0.60]{notre_histoire.png}}
     	\caption{La page contenant l'histoire du club}
     \end{figure}
     \begin{figure}[H]
     	\centering
  	\fbox{\includegraphics[scale=0.60]{album_photo.png}}
     	\caption{La page contenant l'album photo}
     \end{figure}
     \begin{figure}[H]
     	\centering
  	\fbox{\includegraphics[scale=0.60]{cours_particulier_recherche_partenaire.png}}
